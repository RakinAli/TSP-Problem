...
/**
 * Calculates a greedy tour for the given nodes.
 * 
 * @param nodes The vector of points representing the nodes.
 * @param n The number of nodes.
 * @return A vector of integers representing the greedy tour.
 */
std::vector<int> greedyTour(const std::vector<Point> &nodes, int n)
{
  /**
   * Starts on the first node, index 0
  */
...
int main(void)
{
  ...
  // RRNN
  std::vector<int> tour3 = RRNN(nodes, distance_matrix, 5, 1.8);
